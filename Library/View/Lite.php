...
/*
 * @Author: Brightness
 * @Date: 2020-10-21 18:45:31
 * @LastEditors: Brightness
 * @LastEditTime: 2020-10-22 09:55:31
...
class View_Lite {
	...
	public function load($name, $param=array()){  
		...
		$view = dirname(API_ROOT) . DIRECTORY_SEPARATOR . $this->item . DIRECTORY_SEPARATOR .'View'. DIRECTORY_SEPARATOR . $this->type . DIRECTORY_SEPARATOR . $name . '.html';
	  //合并参数
